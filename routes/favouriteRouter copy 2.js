...
.post( cors.corsWithOptions, (req, res, next) => { 
    if (req.body) {  
        ...
        const foundDish = Dishes.findById(obj._id);
        console.log("FoundDish"+foundDish);
        console.log(req.user)  
        const foundUser = User.findById( req.user_id);
            ...
            res.send("provide dish parameters");
        }
});
...
.post( cors.corsWithOptions, (req, res, next) => {  //  authenticate.verifyUser,
    ...
    if (req.params.dishId) {
        ...
        res.send("No dish parameter provided")
    }
     //   }
    })
// })
.put(cors.corsWithOptions,    (req, res, next) => {  // authenticate.verifyUser,
    ...
    Favourites.findOneAndUpdate({_id:req.params.dishId}, 
...
.delete(cors.corsWithOptions,(req, res, next) => {  // authenticate.verifyUser, 
    const dish = Favourites.findOne( req.params.dishId);
    console.log("dish",dish);
